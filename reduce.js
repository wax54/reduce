/*
Write a function called extractValue which 
    accepts an array of objects and a key and 
...
Write a function called vowelCount 
    which accepts a string and returns an 
    object with the keys as the vowel and the 
...
returns the array of objects passed to it 
with each object now including the key and 
...
function at that specific value is true, the value should 
be placed in the first subarray. If the result of the callback 
function at that specific value is false, the value should 
be placed in the second subarray. 
